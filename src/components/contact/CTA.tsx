...
export function CTA() {
  return (
    <section className="relative overflow-hidden bg-gradient-to-br from-[#0F2343] via-[#0F2343] to-[#D4AF37]/20">
      ...
      <div className="relative mx-auto max-w-(--container-max) px-4 py-16 sm:px-6 lg:px-8 lg:py-20">
        ...
        >
          ...
          <motion.p
            ...
            className="mt-4 text-center text-base leading-relaxed text-white/60 md:text-lg"
          >
            Konsultasikan rencana perjalanan umroh Anda bersama tim Safiq Tour.
            Kami siap memberikan pelayanan terbaik dengan penuh amanah.
          </motion.p>
